          ...
          <ResponsiveContainer width="100%" height="100%">
            <PieChart margin={{ top: 12, right: 12, bottom: 12, left: 12 }}>
              <Pie
                ...
                cx="50%"
                cy="50%"
                outerRadius={isSmDown ? "70%" : "78%"}
                labelLine={false}
                // On phones: no labels (they get clipped). On larger screens: show labels.
                label={isSmDown ? false : ({ value }) => (data.length ? fmtGBP(Number(value)) : "")}
              >
